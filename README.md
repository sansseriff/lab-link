...
instrument control software. Python owns hardware state and side effects; the
browser receives snapshots and JSON Patch updates, sends commands, and handles
structured command errors.

The project is published as two packages:

- `lab-link` on PyPI for the FastAPI/Pydantic backend.
